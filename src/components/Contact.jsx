    ...
    <div className="container mx-auto bg-green-50 rounded-lg px-7 md:px-10 lg:px-14 2xl:px-20 py-10 md:py-14 lg:py-18 xl:py-20 2xl:py-[100px] ">
        <div className="flex items-center flex-col md:flex-row ">
            <div className="py-5 sm:p-5 flex-1 aos-init aos-animate" data-aos="zoom-in-up" data-aos-duration="1000">
                ...
                <h2 className="text-Garamond text-[22px] sm:text-2xl md:text-3xl lg:text-4xl 2xl:text-[38px] leading-7 md:leading-8 lg:leading-9 xl:leading-10 2xl:leading-[44px] text-uppercase text-[#0b6f54] dark:text-white font-extrabold my-3 md:my-5">CONTACT WITH US</h2>
                <p className="text-Lora text-sm sm:text-base leading-[26px]   dark: font-normal">Rapidiously myocardinate cross-platform intellectual capital after the model. Appropriately create interactive infrastructures after maintance Holisticly facilitate stand-alone</p>
                <div className="flex items-center my-4 md:my-5 lg:my-[26px] group">
                    ...
                    <div
                        ...
                        <p className=" text-sm leading-[26px]  dark: font-normal">Call Us Now</p>
                        <p className=" text-lg  leading-[26px]  dark:text-white font-bold">(+088) 210 - 123 - 4567</p>
                </div>
            </div>
            <hr className="   h-[1px]"/>
            <div className="flex items-center my-4 md:my-5 lg:my-[26px] group">
               ...
               <MdEmail />
                ...
                <div
                    className="ml-3 md:ml-4">
                    <p className=" text-sm leading-[26px]  dark: font-normal">Send Email</p>
                    <p className=" text-lg   leading-[26px]  dark:text-white font-bold ">info@suitespot.com</p>
            </div>
        </div>
        <hr className="  h-[1px]"/>
        <div className="flex items-center my-4 md:my-5 lg:my-[26px] group">
            ...
            <div
                className="ml-3 md:ml-4">
                <p className=" text-sm leading-[26px]  dark: font-normal">Our Locations</p>
                <p className=" text-base  leading-[26px]  dark:text-white font-bold ">47 W 13th St, New York, <br /> NY 10011, USA</p>
        </div>
    </div>
</div>
